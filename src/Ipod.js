...
class Ipod extends React.Component{
    ...
    rotateWheel = () => {
        ...
        //ZingTouch is an extensive JavaScript library that you can use to make it easy to control your website via gestures
    ...
    //redering structure and design of ipod container
    render(){
        return(
